...
import br.com.litecode.domain.model.UserSetting;
...
public class NotificationMessage implements Serializable {
	...
	public static NotificationMessage create(Session session, String eventType, UserSetting userSetting) {
		...
		return new NotificationMessage(session.getSessionId(), eventType.toLowerCase(), messageSummary, messageDetail, userSetting);
	}
}
